...
\begin{example}[title = Minimum independent set]
    ...
    \textbf{Certificate}. \\ 
    In this problem or language, the certificate coincides with the independent set $W$. Check its cardinality and independency is quite easy, but what is really 
