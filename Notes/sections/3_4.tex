...
\begin{enumerate}
    ...
    \item \textbf{Exponents are often small} \\ The exponent $c$ bounding the time of any Turing Machine capable to decide (solve) a language $L$ (decision problem) such that $L \in \textbf{P}$ can be huge. Anyway, in almost of the cases, the computational tasks solved have a complexity not greater than quadratic or cubic.
